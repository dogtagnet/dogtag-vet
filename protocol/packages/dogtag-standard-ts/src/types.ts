...
export function issuerWhitelistPermitsPass(s: IssuerWhitelistState): boolean {
...
export function issuerStorePermitsPass(s: IssuerStoreAgreement): boolean {
  return s !== "DIFFERS";
}
...
export type IssuerAnchor = {kind: "resolved"; clone: string} | {kind: "noRecord"} | {kind: "noFactoryConfigured"};
